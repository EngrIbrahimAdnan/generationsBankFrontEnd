    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f8fcfd] to-white py-16 px-4 sm:px-6 lg:px-8">
      ...
      >
        <motion.div variants={fadeInUp} className="text-center">
          <h1 className="text-4xl font-bold text-[#35579b]">Privacy Policy</h1>
        ...
        <motion.div variants={fadeInUp}>
          <Card>
            ...
            <CardContent className="text-[#35579b]/70">
              At Guardian, we are committed to protecting your privacy and
              ensuring the security of your personal information. This privacy
              policy explains how we collect, use, and safeguard your data when
              you use our banking services.
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div variants={fadeInUp}>
          <Card>
            ...
            <CardContent className="text-[#35579b]/70">
              ...
              handle your data, please don't hesitate to contact us at
              privacy@guardian.com or through our customer support channels.
            </CardContent>
          </Card>
        </motion.div>
